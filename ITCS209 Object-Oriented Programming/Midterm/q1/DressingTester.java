...
public class DressingTester {
	...
	public static void main(String[] args) {
		...
		int temperature2  = 45;
		System.out.println("[closet@2]Today temperature  is "+temperature2 +" degree, you have "+Dressing.get_NumAllClothesByTemp(closet2, temperature2)+" appropriate clothes to wear.");
