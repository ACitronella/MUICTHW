...
public class ShapeTester {
	public static void main(String[] args){
		...
		shapeMap.put("PiArea", new Circle(1));
		shapeMap.put("12-lenSquare", new Square(12));

		System.out.println("--------------------");
		System.out.println("Number of invalid shape's name is " + countInvalidName(shapeMap));
		
		drawObj(new Triangle(100, 50));
		drawObj(new Square(100));
		drawObj(new Circle(100));
	...
	public static void printAllShapes(HashMap<String, Shape> shapes) {
		// YOUR CODE GOES HERE
		shapes.forEach((key, shape) -> System.out.println(key + "->" + shape.toString()));
	}
	...
	public static void drawObj(Shape s){
